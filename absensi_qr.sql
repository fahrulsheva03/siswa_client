...
CREATE TABLE `kelas` (
    ...
    `latitude` varchar(50) DEFAULT '-5.1476',
    `longitude` varchar(50) DEFAULT '119.4327',
...
--
ALTER TABLE `kelas` ADD PRIMARY KEY (`id_kelas`);
...
--
ALTER TABLE `siswa` MODIFY `id_siswa` int NOT NULL AUTO_INCREMENT;
